    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <div className="break"></div>
                <div className="info_content">Circolors brings a punk DIY ethos to the world of NFTs. No paid promo, no shady influencer deals. Just art, vibes and education.</div>
            </div>
        </div>
    )
};
